function mouseOverAction(e){
  ...
  if (e.children()[0].className == "yt-video"){
    ...
    e.html('<video autoplay loop muted width="'+ e.children()[0].width +'" height="'+ e.children()[0].height +'"><source src="videos/gallery/' + e.attr("href").split("/").pop().split(".")[0] + '.webm" type="video/webM"><source src="videos/gallery/' + e.attr("href").split("/").pop().split(".")[0] + '.ogv" type="video/ogg"><source src="' + e.attr("href") + '" type="video/mp4"></video>');
  }
};
          ...
          '<div id="lightbox">' +
            '<div id="lightbox-content">' +
              '<div id="lightbox-v-overlay">' +
                  '<video controls autoplay loop disablePictureInPicture oncontextmenu="return false;" controlsList="nodownload"><source src="videos/gallery/' + title + '.webm" type="video/webM"><source src="videos/gallery/' + title + '.ogv" type="video/ogg"><source src="' + src + '" type="video/mp4"></video>' +
                  '<p>' + title + '</p>' +
              '</div>' +
            '</div>' +
          '</div>';
